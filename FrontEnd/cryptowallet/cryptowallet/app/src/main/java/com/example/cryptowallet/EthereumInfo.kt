...
class EthereumInfo : AppCompatActivity() {
                    ...
                    for ((name, detailsArray) in walletDetails) {
                        if (name != "Total balance") {
                            ...
                            if (name == "Ethereum"){
                                ...
                                val ethereumpa = findViewById<TextView>(R.id.ETHadd)
                                val epublicaddress = detailsArray[2]
                                ethereumpa.text= ("Public Address: "+epublicaddress)

                                val ethereumbalance = findViewById<TextView>(R.id.ETHAsset)
