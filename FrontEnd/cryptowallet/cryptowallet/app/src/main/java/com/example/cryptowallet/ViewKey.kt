...
class ViewKey: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val Bitcoin_PrivateKey = findViewById<Button>(R.id.bitcoinButton2)
        Bitcoin_PrivateKey.setOnClickListener {
            val intent = Intent(this, BitcoinPrivateKey::class.java)
            startActivity(intent)
        }

        val Ethereum_PrivateKey = findViewById<Button>(R.id.ethereumButton2)
        Ethereum_PrivateKey.setOnClickListener {
            val intent = Intent(this, EthereumPrivateKey::class.java)
            startActivity(intent)
        }
