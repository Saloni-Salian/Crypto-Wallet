...
class SendFunds : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bitcoinButton = findViewById<Button>(R.id.bitcoinButton2)
        bitcoinButton.setOnClickListener {
            val intent = Intent(this, SendBitcoin::class.java)
            startActivity(intent)
        }

        val ethereumButton = findViewById<Button>(R.id.ethereumButton2)
       ethereumButton.setOnClickListener {
            val intent = Intent(this, SendEthereum::class.java)
            startActivity(intent)
        }
